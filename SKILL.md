...
- **Premium HTML report** — 3-tier rendering (Executive / Coach / Technical) generated by the Closing Code AI backend
...
4. Backend generates **premium HTML report** — 3-tier rendering:
   - **N1 Executive**: Verdict, score, 3 action items
   - **N2 Coach**: Errors with evidence, timestamps, scripts
   - **N3 Technical**: Full breakdown (collapsed)
...
- [ ] Report delivered as link to HTML 3-tier report (Executive/Coach/Technical) generated by backend
